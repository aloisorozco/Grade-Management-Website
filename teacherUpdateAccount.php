...
$q1 = "SELECT firstName, lastName FROM teachers WHERE id='{$_COOKIE['id']}' LIMIT 1";
...
if (isset($_POST['email'])) {
    ...
    $q2 = "UPDATE teachers SET firstName = ?, lastName = ?, email = ?, password = ? WHERE id = ? AND email = ? AND password = ?";
    ...
    //try {
        ...
        //should have a pop up msg in teacherMainPage but whatever
        exit();
}
        ...
        <div class="container-fluid text-center" id="container-div">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-8" id="register-form-div">
                    <form action="teacherUpdateAccount.php" id="teacherRegisterForm" method="post">
                        ...
                        <div class="mb-3 text-div">
                            <div class="mb-2 ind-div">
                                ...
                                <?php 
                                    echo '<input type="text" class="form-control" id="first-name" name="first-name"' . 'value="'. $teacher->firstName .'">';
                                ?>
                            </div>
                            <div class="mb-2 ind-div">
                                <label for="last-name" class="form-label" id="validLastNameMsg">Last Name</label>
                                <?php 
                                    echo '<input type="text" class="form-control" id="last-name" name="last-name"' . 'value="'. $teacher->lastName .'">';
                                ?>
                            </div>
                          </div>
                        <div class="mb-3 text-div">
